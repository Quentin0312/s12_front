...
import { opponentTurnMessageLanguageDictType, playerRedTurn, playerYellowTurn, yourTurnMessageLanguageDictType } from "../languageDict"
...
export default function () {
    ...
    const messageToDisplay = () =>  actualPage() == PageEnum.local
        ? turn() == PieceEnum.red 
