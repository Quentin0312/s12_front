...
import { GameStepEnum, PieceEnum, gameStep, turn } from "../components/gameContext";
...
export function isMoveLegal(row: number, column: number, playerPieceColor: PieceEnum): boolean {
